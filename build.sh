...
# download cmake
startBlock cmake
export FF_CMAKE_VERSION=3.11.1
...
./configure --prefix="$FF_OUT" --enable-shared=no --disable-ipcrm --disable-ipcs --disable-wall
...
startBlock fdk-aac
cd "$FF_SOURCE"
curl -O -L https://netcologne.dl.sourceforge.net/project/opencore-amr/fdk-aac/fdk-aac-0.1.6.tar.gz
