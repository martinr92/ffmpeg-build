# FFmpeg-build
[![Build Status](https://travis-ci.org/martinr92/ffmpeg-build.svg?branch=v1.0.4)](https://travis-ci.org/martinr92/ffmpeg-build/branches)
Last Release v1.0.4
...
- FF_VERSION = ffmpeg version (e.g. 3.4 or snapshot)
